    ...
    return (
        <div className="min-h-screen w-full flex bg-stone-50 lg:p-4 md:p-4 pt-24 mt-10">
            ...
            <div className="hidden lg:flex w-1/2 relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                    src="https://images.unsplash.com/photo-1544442069-97dded965a9f?q=80&w=1931&auto=format&fit=crop"
                    alt="Trekking mountains"
                    fill
                ...
                <div className="absolute bottom-12 left-12 text-white z-10 max-w-lg">
                    ...
                    <h2 className="text-4xl font-bold mb-4 leading-tight">Return to the mountains.</h2>
                    <p className="text-lg text-white/80 leading-relaxed">
                        "The climb speaks to our character, but the view speaks to our souls."
                        <br />— Welcome back to 30°North.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
                {/* Background blobs for premium feel on mobile/clean areas */}
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center lg:text-left space-y-2">
                        ...
                        <p className="text-zinc-500">
                            Enter your details to access your personalized trekking dashboard.
                        </p>
                    </div>
                    ...
                    <form className="space-y-6 mt-8" onSubmit={(e) => e.preventDefault()}>
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#" className="text-sm font-medium text-orange-600 hover:text-orange-500 transition-colors">Forgot password?</a>
                                </div>
                                <div className="relative">
                                    <input
                                        id="password"
                        ...
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-2 rounded-xl bg-orange-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-orange-500/30 hover:bg-orange-700 hover:shadow-orange-500/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600 transition-all duration-300"
                        >
                            Sign in to account
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-stone-50 px-2 text-sm text-zinc-500">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        {/* Facebook */}
                        <button className="flex items-center justify-center px-4 py-3 border border-zinc-200 rounded-xl bg-white hover:bg-zinc-50 hover:border-zinc-300 transition-all shadow-sm group">
                            <svg className="h-5 w-5 text-[#1877F2] opacity-80 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
